...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static List<DrawerItem> getData(){
        ...
        int[] icons = {R.drawable.ic_menu_black_24dp, R.drawable.ic_menu_grey600_24dp, R.drawable.ic_menu_black_24dp, R.drawable.ic_menu_grey600_24dp};
        String[] titels = {"Title 1", "Title 2", "Title 3", "Title 4"};
